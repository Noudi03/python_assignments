...
# splitting the random number in pairs of two and adding them to the dictionary
...
# every number in the list will now be substituted by
...
[list_no_dupes.append(number)
 for number in split_random if number not in list_no_dupes]
